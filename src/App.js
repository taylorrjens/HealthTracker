    ...
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <Paper style={{ width: "400px", marginTop: 30, padding: "40px" }}>
          <TextField fullWidth={true} placeholder="email" 
            value = {email} onChange={(e) => {setEmail(e.target.value)}}/>
          <TextField value = {password} onChange={(e) => {setPassword(e.target.value)}} 
            fullWidth={true} placeholder="password" style={{ marginTop: 20 }}
          />
          <div
            style={{
              display: "flex",
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Typography color="inherit" style={{ marginRight: 30 }}>
            ...
            <Button onClick={handleSignOut} type={'password'} color="inherit">Sign Out</Button>
        </Toolbar>
      </AppBar>
      <Drawer
        open={drawer_open}
